...
<aside>
    ...
    <form:form method="get" action="${listPage}" commandName="advertisementSearchingForm">
        ...
        <div class="cate" id="cate">
            <p class="pcate"><form:checkbox id="one1" path="categories" value="games"/> <label for="one1"> <span
                    name="cate"></span>Игры</label></p>

            <p class="pcate"><form:checkbox id="two2" path="categories" value="clothes"/> <label for="two2"> <span
                    name="cate"></span>Одежда</label></p>

            <p class="pcate"><form:checkbox id="three3" path="categories" value="notclothes"/> <label for="three3"><span
                    name="cate"></span>Не одежда</label></p>
