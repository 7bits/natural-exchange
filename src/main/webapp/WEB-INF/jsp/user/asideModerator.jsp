...
<aside>
    <c:url  value="/moderator/userlist.html" var="listPage">
        <c:param name="currentCategory" value="${currentCategory}"/>
    </c:url>
    <form:form method="GET" action="${listPage}" commandName="userSearchingForm">
        ...
        <div class="cate" id="cate">
            <p class="pcate"><form:checkbox id="two2" path="categories" value="banned"/> <label for="two2"> <span class="moderator" name="cate"></span>Забаненные</label></p>
