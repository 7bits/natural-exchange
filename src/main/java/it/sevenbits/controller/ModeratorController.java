...
import it.sevenbits.util.form.user.SearchUserForm;
...
public class ModeratorController {
    ...
    public ModelAndView showAllAdvertisements(
        ...
        DatePair datePair = AdvertisementOperations.takeAndValidateDate(previousDateFrom, previousDateTo, bindingResult,
            modelAndView, this.advertisementSearchingValidator);
    ...
    public ModelAndView administrationPage(
        ...
        DatePair datePair = AdvertisementOperations.takeAndValidateDate(dateFromString, dateToString, bindingResult,
            modelAndView, this.advertisementSearchingValidator);
        Long dateFrom = datePair.getDateFrom();
        Long dateTo = datePair.getDateTo();
