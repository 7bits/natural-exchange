...
import it.sevenbits.web.util.form.validator.user.VkEntryEmailFormValidator;
...
public class VKAuthorizationController {
    ...
    public String registrationComplete(final VkEntryEmailForm vkEntryEmailForm, final BindingResult bindingResult, final Model model) {
